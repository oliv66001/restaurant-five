...
class CategoriesFixtures extends Fixture
{
    ...
    {
        $parent = $this->createCategory(name: 'Carte des entrées', parent: null, manager: $manager);
        ...
        $parent = $this->createCategory(name: 'Carte des plats', parent: null, manager: $manager);
            $this->createCategory(name: 'Plats', parent: $parent, manager: $manager);

        $parent = $this->createCategory(name: 'Carte des desserts et fromages', parent: null, manager: $manager);
        ...
        $parent = $this->createCategory(name: 'Carte des menus', parent: null, manager: $manager);
        ...
        $parent = $this->createCategory(name: 'Carte des boissons et des vins', parent: null, manager: $manager);
