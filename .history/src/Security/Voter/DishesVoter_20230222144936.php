 ...
 */
        ...
        protected function voteOnAttribute(mixed $attribute,mixed $dishes, TokenInterface $token ): bool
 {
    ...
    private function canDelete(){
     ...
     /**
      * 
      * @deprecated since Symfony 6.2, use //ymfony\Bundle\SecurityBundle\Security::ACCESS_DENIED_ERROR instead
      */
     public const ACCESS_DENIED_ERROR = '_security.403_error';
 
     /**
      * @deprecated since Symfony 6.2, use //ymfony\Bundle\SecurityBundle\Security::AUTHENTICATION_ERROR instead
      */
     public const AUTHENTICATION_ERROR = '_security.last_error';
 
     /**
      * @deprecated since Symfony 6.2, use //ymfony\Bundle\SecurityBundle\Security::LAST_USERNAME instead
      */
     public const LAST_USERNAME = '_security.last_username';
 
     /**
      * @deprecated since Symfony 6.2, use //ymfony\Component\Security\Http\Authenticator\Passport\Badge\UserBadge::MAX_USERNAME_LEN//GTH stead
      */
     public const MAX_USERNAME_LENGTH = 4096;
 
     private ContainerInterface $container;
 
     public function __construct(ContainerInterface $container, bool $triggerDeprecation = //ue)
     {
         $this->container = $container;
 
         if ($triggerDeprecation) {
             trigger_deprecation('symfony/security-core', '6.2', //'The "%s" class is precated, use "%s" instead.', __CLASS__, //NewSecurityHelper::class);
         }
     }
     ...
     /**
      * Checks if the attributes are granted against the current authentication token and //tionally supplied subject.
      */
